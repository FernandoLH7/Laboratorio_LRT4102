...
class MoveTurtlePIDControl:
    def __init__(self):
        ...
        # Variables para el control derivativo e integral
        self.last_error_x = 0
        self.last_error_y = 0
    ...
    def move_turtle_to_desired_x_y(self, desired_x, desired_y):
        # Constantes de proporcionalidad, derivativa e integral del controlador (ajustables)
        Kp = 1
        Kd = 0.1
        Ki = 0.01
        ...
        while not rospy.is_shutdown():
            ...
            vel_x = Kp * error_x + Kd * (error_x - self.last_error_x) + Ki * self.integral_error_x
            vel_y = Kp * error_y + Kd * (error_y - self.last_error_y) + Ki * self.integral_error_y
    ...
    def rotate_turtle_to_desired_theta(self, desired_theta):
        ...
        while not rospy.is_shutdown():
            ...
            angular_z = (Kp_theta * error_theta +
                         Kd_theta * (error_theta - self.last_error_theta) +
                         Ki_theta * self.integral_error_theta)
